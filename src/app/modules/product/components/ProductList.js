                            ...
                            <div className="block2-overlay trans-0-4">
                                <div className="block2-btn-addcart w-size1 trans-0-4">
                                    { (this.state.isAdded == false) ? 
                                        <button className="size1 btn-add-cart bo-rad-23 hov1 s-text1 trans-0-4" onClick={ () => this.handleAddCart(post) }>
                                            <i className="fa fa-shopping-cart" aria-hidden="true"/> Đặt mua
                                        </button>
                                        :
                                        <button className="size1 btn-add-cart bo-rad-23 hov1 s-text1 trans-0-4 is-added">
                                            Đang thêm...
                                        </button>
                                    }
                                </div>
